...
//         {/* 💡 Highlight IITians in subtitle */}
//         <Typography className={styles.subtitle}>
//           Whether you're a student starting out, a professional upskilling, or making a career change –
//           we have the perfect learning path for you. <strong>Learn from top IITians and industry experts.</strong>
//         </Typography>
...
//   <Box
//     className={`${styles.pathOption} ${selectedPath === 'student' ? styles.pathOptionSelected  : ''}`}
//     onClick={() => setSelectedPath('student')}
//   >
...
//   <Box
//     className={`${styles.pathOption} ${selectedPath === 'professional' ? styles.pathOptionSelected  : ''}`}
//     onClick={() => setSelectedPath('professional')}
//   >
//     <WorkIcon className={styles.icon} />
//     <div>
//       <strong>Professional</strong><br />
//       <span>Advance your current role</span>
//     </div>
//   </Box>

//   <Box
//     className={`${styles.pathOption} ${selectedPath === 'career' ? styles.pathOptionSelected  : ''}`}
//     onClick={() => setSelectedPath('career')}
//   >
//     <SwapHorizIcon className={styles.icon} />
//     <div>
//       <strong>Career Changer</strong><br />
//       <span>Switch to a new field</span>
//     </div>
//   </Box>
...
>
  <DialogTitle className={styles.dialogTitle}>
    <RocketLaunchIcon className={styles.dialogIcon} />
